...
print("Pre-computando escenarios Monte Carlo...")
print(f"  Combinaciones: {len(GRID_A)} × {len(GRID_F)} × {len(GRID_YR)} "
      f"= {len(GRID_A)*len(GRID_F)*len(GRID_YR)} × {N_SIMS} sims cada una")
